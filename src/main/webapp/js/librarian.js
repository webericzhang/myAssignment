(function () {
    ...
    librarian.config(["$routeProvider", function ($rootProvider) {
        $rootProvider
            .when("/coursesCatalog", {
                templateUrl: "dist/html/coursesCatalog.html",
                controller: "CoursesCatalogCtrl"
            })
            .when("/creatingCourse", {
                templateUrl: "dist/html/creatingCourse.html",
                controller: "CreateCourseCtrl"
            })
            .when("/updatingCourse", {
                templateUrl: "dist/html/updatingCourse.html",
                controller: "UpdatingCourseCtrl"
            })
            .otherwise({
    ...
    librarian.controller("UpdatingCourseCtrl", ["$scope", "$location", "CourseServiceResource", "TeacherServiceResource", "LevelServiceResource", 
        function ($scope, $location, CourseServiceResource, TeacherServiceResource, LevelServiceResource) {
